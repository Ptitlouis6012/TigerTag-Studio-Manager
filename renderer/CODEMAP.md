...
## Display name + friend requests (L31928-34640)
| L | What | Anchors |
|---|---|---|
...
## Keys + profile sync (L32785-34790)
| L | What | Anchors |
|---|---|---|
...
## User doc sync + telemetry + bootstrap (L33328-36440)
| L | What | Anchors |
|---|---|---|
...
## Electron RFID integration (L34465-36690)
| L | What | Anchors |
|---|---|---|
