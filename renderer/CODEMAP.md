...
## Account dropdown + sidebar states (L1767-1970)
...
## Add Product panel — ADP (L2032-3322)
...
## Settings / Friends / Account modals (L3819-4621)
...
## Login + accounts persistence (L4694-4972)
...
## RFID encode / burn modal — cem (L11200-11700)
| L | What | Anchors |
|---|---|---|
...
## TigerTag+ catalogue (L11537-14000)
| L | What | Anchors |
|---|---|---|
...
## Spool detail panel (L6057-26296)
| L | What | Anchors |
|---|---|---|
...
## Panels / debug / auto-update (L19259-20440)
| L | What | Anchors |
|---|---|---|
...
## Friends rendering (L20440-21030)
| L | What | Anchors |
|---|---|---|
...
## Racks + printers subscriptions (L21030-21400)
| L | What | Anchors |
|---|---|---|
...
## Printer detail side panel (L23860-27340)
| L | What | Anchors |
|---|---|---|
...
## Storage view render + DnD (L29437-31900)
| L | What | Anchors |
|---|---|---|
...
## Display name + friend requests (L31928-33760)
| L | What | Anchors |
|---|---|---|
...
## Keys + profile sync (L32785-33900)
| L | What | Anchors |
|---|---|---|
...
## User doc sync + telemetry + bootstrap (L33328-35560)
| L | What | Anchors |
|---|---|---|
...
## Electron RFID integration (L34465-35700)
| L | What | Anchors |
|---|---|---|
